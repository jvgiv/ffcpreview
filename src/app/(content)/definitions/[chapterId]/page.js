  ...
  return (
    ...
    >
      <div className="ch-header">
        <div id="chEyebrow" className="ch-eyebrow">
          Hole {chapter.id} of {chapters.length} · ◷ {chapter.terms[0][7]} -{" "}
          {chapter.terms[19][7]}
        </div>
        <div className="ch-title-wrap">
          <div id="chNum" className="ch-num">
            {chapter.num}
          </div>
          <div id="chName" className="ch-name">
            {chapter.title}
          </div>
        </div>
        <p id="chFocus" className="ch-focus">
          {chapter.focus}
        </p>
        {/* CLOCK GOES HERE */}
